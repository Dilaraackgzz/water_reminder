...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xff5FA8A3),
      surfaceTint: Color(0xff7EBFBA),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xffB8E3DF),
      onPrimaryContainer: Color(0xff1A4945),
      secondary: Color(0xff8EA9B3),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xffD4E6ED),
      onSecondaryContainer: Color(0xff2C3E47),
      tertiary: Color(0xffA8B8C5),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xffDDE8F0),
      onTertiaryContainer: Color(0xff354551),
      error: Color(0xffD67B79),
      onError: Color(0xffffffff),
      errorContainer: Color(0xffF5D0CF),
      onErrorContainer: Color(0xff5A2625),
      surface: Color(0xffF8FAFA),
      onSurface: Color(0xff2A3538),
      onSurfaceVariant: Color(0xff5A6568),
      outline: Color(0xffA0AAAD),
      outlineVariant: Color(0xffD4DADE),
      shadow: Color(0xff000000),
      scrim: Color(0xff000000),
      inverseSurface: Color(0xff2F3739),
      inversePrimary: Color(0xffA3D5D0),
      primaryFixed: Color(0xffD1F0EC),
      onPrimaryFixed: Color(0xff0D3834),
      primaryFixedDim: Color(0xffA3D5D0),
      onPrimaryFixedVariant: Color(0xff3D7A76),
      secondaryFixed: Color(0xffE3F1F7),
      onSecondaryFixed: Color(0xff1A2D36),
      secondaryFixedDim: Color(0xffC1D9E3),
      onSecondaryFixedVariant: Color(0xff5A7581),
      tertiaryFixed: Color(0xffEAF3F8),
      onTertiaryFixed: Color(0xff1F3340),
      tertiaryFixedDim: Color(0xffCEDDE8),
      onTertiaryFixedVariant: Color(0xff6A7E8E),
      surfaceDim: Color(0xffE1E7E9),
      surfaceBright: Color(0xffF8FAFA),
      surfaceContainerLowest: Color(0xffffffff),
      surfaceContainerLow: Color(0xffF2F5F6),
      surfaceContainer: Color(0xffECF0F1),
      surfaceContainerHigh: Color(0xffE6EAEC),
      surfaceContainerHighest: Color(0xffE0E5E7),
    );
  }
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xff8FC9C4),
      surfaceTint: Color(0xff8FC9C4),
      onPrimary: Color(0xff1A4945),
      primaryContainer: Color(0xff3D7A76),
      onPrimaryContainer: Color(0xffD1F0EC),
      secondary: Color(0xffA8C5D1),
      onSecondary: Color(0xff2C3E47),
      secondaryContainer: Color(0xff5A7581),
      onSecondaryContainer: Color(0xffE3F1F7),
      tertiary: Color(0xffB8CBD8),
      onTertiary: Color(0xff354551),
      tertiaryContainer: Color(0xff6A7E8E),
      onTertiaryContainer: Color(0xffEAF3F8),
      error: Color(0xffE89D9B),
      onError: Color(0xff5A2625),
      errorContainer: Color(0xffA35856),
      onErrorContainer: Color(0xffF5D0CF),
      surface: Color(0xff1A2224),
      onSurface: Color(0xffE3E8EA),
      onSurfaceVariant: Color(0xffC1CACD),
      outline: Color(0xff738286),
      outlineVariant: Color(0xff3F484B),
      shadow: Color(0xff000000),
      scrim: Color(0xff000000),
      inverseSurface: Color(0xffE3E8EA),
      inversePrimary: Color(0xff5FA8A3),
      primaryFixed: Color(0xffD1F0EC),
      onPrimaryFixed: Color(0xff0D3834),
      primaryFixedDim: Color(0xffA3D5D0),
      onPrimaryFixedVariant: Color(0xff3D7A76),
      ...
      tertiaryFixedDim: Color(0xffCEDDE8),
      onTertiaryFixedVariant: Color(0xff6A7E8E),
      surfaceDim: Color(0xff1A2224),
      surfaceBright: Color(0xff3A4345),
      surfaceContainerLowest: Color(0xff141A1C),
      surfaceContainerLow: Color(0xff232A2C),
      surfaceContainer: Color(0xff2A3133),
      surfaceContainerHigh: Color(0xff343B3D),
      surfaceContainerHighest: Color(0xff3F4648),
    );
  }
